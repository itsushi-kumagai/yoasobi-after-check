    ...
    <div class="contents">
        ...
        <div class="use_contents">        
            ...
            <div class="Description">
                <h3><span style="color: #F70661; margin-right: 1rem;">●</span>Register</h3>
        ...
        <div class="use_contents use_contents2">           
            <div class="Description" style="align-items: center;">
                <h3><span style="color: #F70661; margin-right: 1rem;">●</span>Create a profile</h3>
        ...
        <div class="use_contents">        
            <img src="../../LPImages/phone image 3.png" alt="event search page image">
                <div class="Description">
                    ...
                    <p>Look at recommended events</p>
