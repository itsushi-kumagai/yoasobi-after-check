                ...
                <div class="prompt-contents">
                    <div class="prompt-inner">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="text-box">
                                <div class="text">
                                    <label for="email"><p>Password<br>(6 characters minimum)</p></label>
                                </div>
                                <div class="box">
                                    <input type="text" id="email" name="password" @error('password') is-invalid @enderror" name="password" required autocomplete="new-password"><br>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="pass-link"><a href="/login">Do you have an account ?</a></div>
                    </form>
                    </div>
                </div>
            </div>
