<template>
    <div>
        <button v-if="show" @click.prevent="unsave()" class="fav-icon"><i class="fas fa-heart fa-2x" style="color: #F70661;"></i></button>
        <button v-else @click.prevent="save()" class="fav-icon"><i class="fas fa-heart fa-2x" style="color: white;"></i></button>
    </div>
</template>
